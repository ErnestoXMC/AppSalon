...
class Email{
    ...
    public function confirmarCuenta(){
        ...
        $contenido .= "<p>Presiona Aquí: <a href='" . $_ENV['APP'] . "/confirmar-cuenta?token=". $this->token ."'>Confirma tu Cuenta.</a></p>";
    ...
    public function enviarInstrucciones(){
          ...
          $contenido .= "<p>Presiona Aquí: <a href='" . $_ENV['APP'] . "/recuperar?token=". $this->token ."'>Reestablecer Password.</a></p>";
